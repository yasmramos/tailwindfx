...
class TwInstallTest extends ApplicationTest {
  ...
  void shouldInstallAllCssFiles() {
    ...
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-base")),
        "Should include base CSS");
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-components")),
        "Should include components CSS");
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-utilities")),
        "Should include utilities CSS");
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-colors")),
        "Should include colors CSS");
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-effects")),
        "Should include effects CSS");
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-components-preset")),
        "Should include components preset CSS");
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-dark")),
        "Should include dark CSS");
  }
  ...
  void shouldInstallComponentsPresetCss() {
    ...
    assertEquals(1, stylesheets.size(), "Should install exactly 1 CSS file");
    assertTrue(
        stylesheets.get(0).contains("tailwindfx-components-preset"),
        "Should be components preset CSS");
  }
  ...
  void shouldInstallEssentials() {
    ...
    assertTrue(
        stylesheets.get(1).contains("tailwindfx-components"), "Second should be components CSS");
    assertTrue(
        stylesheets.get(2).contains("tailwindfx-components-preset"),
        "Third should be components preset CSS");
  }
  ...
  void installShouldDelegateToInstallAll() {
    ...
    List<String> stylesheets = scene.getStylesheets();
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-base")), "Should include base");
    assertTrue(
        stylesheets.stream().anyMatch(s -> s.contains("tailwindfx-dark")), "Should include dark");
  }
