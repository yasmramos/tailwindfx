...
public final class StylesTest {
  ...
  static void testGridPaneSpanGuards() {
    throws_("colSpan(null)", IllegalArgumentException.class, () -> Styles.colSpan(null, 3));
    throws_("colSpan(0)", IllegalArgumentException.class, () -> Styles.colSpan(new Region(), 0));
    throws_("rowSpan(-1)", IllegalArgumentException.class, () -> Styles.rowSpan(new Region(), -1));
  }
  ...
  static void testGridCell() throws Exception {
    runFx(
        () -> {
          ...
          throws_(
              "gridCell(null)", IllegalArgumentException.class, () -> Styles.gridCell(null, 0, 0));
          throws_(
              "gridCell(node,-1,0)",
  ...
  static void testMarginGuards() {
    throws_(
        "margin(null,...)", IllegalArgumentException.class, () -> Styles.margin(null, 4, 4, 4, 4));
    throws_("mx(null,...)", IllegalArgumentException.class, () -> Styles.mx(null, 4));
    throws_(
        "mxWithParent(null,parent)",
        IllegalArgumentException.class,
        () -> Styles.mxWithParent(null, new HBox(), 4));
    throws_(
        "mxWithParent(node,null)",
        IllegalArgumentException.class,
  ...
  static void testGrayscale() throws Exception {
    runFx(
        () -> {
          Region n = new Region();
          Styles.grayscale(n);
          check("grayscale sets effect", n.getEffect() instanceof javafx.scene.effect.ColorAdjust);
          javafx.scene.effect.ColorAdjust ca = (javafx.scene.effect.ColorAdjust) n.getEffect();
  ...
  static void testTextShadow() throws Exception {
    runFx(
        () -> {
          ...
          check(
              "textShadow color sets effect",
              n.getEffect() instanceof javafx.scene.effect.DropShadow);
          javafx.scene.effect.DropShadow ds = (javafx.scene.effect.DropShadow) n.getEffect();
          approx("textShadow offsetY=2", 2.0, ds.getOffsetY());

          throws_(
              "textShadow(null node)",
              IllegalArgumentException.class,
              () -> Styles.textShadowSm(null));
          throws_(
              "textShadow(blank color)",
              IllegalArgumentException.class,
  ...
  static void testDropShadowColored() throws Exception {
    runFx(
        () -> {
          ...
          check(
              "dropShadowBlue sets DropShadow",
              n.getEffect() instanceof javafx.scene.effect.DropShadow);
  ...
  static void testClipCircle() throws Exception {
    runFx(
        () -> {
          Region n = new Region();
          Styles.clipCircle(n);
          check("clipCircle sets clip", n.getClip() instanceof javafx.scene.shape.Circle);
          Styles.clipNone(n);
  ...
  static void testClipRounded() throws Exception {
    runFx(
        () -> {
          ...
          check(
              "clipRounded sets Rectangle clip",
              n.getClip() instanceof javafx.scene.shape.Rectangle);
          javafx.scene.shape.Rectangle r = (javafx.scene.shape.Rectangle) n.getClip();
  ...
  static void testRotateX() throws Exception {
    runFx(
        () -> {
          ...
          Styles.rotateX(n, 30);
          check(
              "rotateX adds Rotate transform",
              n.getTransforms().stream()
                  .anyMatch(
                      t ->
  ...
  static void testGlass() throws Exception {
    runFx(
        () -> {
          Region n = new Region();
          Styles.glass(n);
          check("glass sets BoxBlur", n.getEffect() instanceof javafx.scene.effect.BoxBlur);
          check("glass sets bg-color", n.getStyle().contains("-fx-background-color"));

          Region n2 = new Region();
          Styles.glassDark(n2);
          check("glassDark sets BoxBlur", n2.getEffect() instanceof javafx.scene.effect.BoxBlur);
        });
  }
  ...
  static void testNeumorph() throws Exception {
    runFx(
        () -> {
          ...
          Styles.neumorph(n);
          check(
              "neumorph sets DropShadow", n.getEffect() instanceof javafx.scene.effect.DropShadow);
          check(
              "neumorph sets bg #e0e5ec",
              n.getStyle().contains("#e0e5ec") || n.getStyle().contains("e0e5ec"));

          Region n2 = new Region();
          Styles.neumorphInset(n2);
          check(
              "neumorphInset sets InnerShadow",
  ...
  static void testSvgHelpers() throws Exception {
    runFx(
        () -> {
          ...
          check(
              "stroke sets black",
              rect.getStroke() instanceof javafx.scene.paint.Color c && c.getRed() < 0.01);
          ...
          throws_(
              "fill(null shape)", IllegalArgumentException.class, () -> Styles.fill(null, "#000"));
          throws_(
              "stroke(null shape)",
              IllegalArgumentException.class,
