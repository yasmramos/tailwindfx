...
public class VariantManagerTest extends ApplicationTest {
    ...
    public void testApplyGroupVariantValid() {
        ...
        assertDoesNotThrow(() -> {
            ...
            VariantManager.applyGroupVariant(testButton, "group-focus", "border-red-500", JitCompiler);
        });
    }
    ...
    public void testApplyArbitraryVariantMediaQuery() {
        ...
        assertDoesNotThrow(() -> {
            VariantManager.applyArbitraryVariant(testButton, "[@media(min-width:768px)]", "p-4", JitCompiler);
        });
    }
