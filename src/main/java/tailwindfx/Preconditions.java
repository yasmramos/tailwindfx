...
final class Preconditions {
    ...
    static final Logger LOG = Logger.getLogger("TailwindFX");
    ...
    static <T> T requireNonNull(T value, String method, String paramName) {
        if (value == null) {
    ...
    static <T extends javafx.scene.Node> T requireNode(T node, String method) {
    ...
    static String requireNonBlank(String value, String method, String paramName) {
    ...
    static int requireSpan(int span, String method) {
        if (span < 1) {
            throw new IllegalArgumentException(
    ...
    static int requirePositiveDuration(int ms, String method) {
        if (ms <= 0) {
            throw new IllegalArgumentException(
    ...
    static int requireAlpha(int alpha, String method) {
    ...
    static void warnNoParent(javafx.scene.Node node, String method) {
    ...
    static void warnBrightnessRange(double value, String method) {
    ...
    static void warnNoImage(javafx.scene.image.ImageView iv, String method) {
        if (iv.getImage() == null) {
    ...
    static void warnLikelyTypo(String token, String method) {
