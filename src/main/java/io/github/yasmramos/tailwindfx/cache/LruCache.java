 ...
 *
 * <p>This cache provides bounded storage with automatic eviction of the least recently used
 * entries when the capacity is exceeded. It is designed for high-concurrency scenarios with
 * minimal lock contention.</p>
 *
 * <h3>Key Features:</h3>
 * <ul>
 *   <li><b>Thread-safe:</b> Uses read-write locks for concurrent access</li>
 *   <li><b>LRU eviction:</b> Automatically removes least recently used entries</li>
 *   <li><b>Bounded capacity:</b> Prevents unbounded memory growth</li>
 *   <li><b>Generic:</b> Works with any key/value types</li>
 *   <li><b>Metrics:</b> Tracks hits, misses, and evictions</li>
 * </ul>
 *
 * <h3>Performance Characteristics:</h3>
 * <ul>
 *   <li>Get: O(1) average case</li>
 *   <li>Put: O(1) average case</li>
...
public class LruCache<K, V> {
    ...
    public LruCache(int maxCapacity) {
        if (maxCapacity <= 0) {
            throw new IllegalArgumentException(
                "LruCache: maxCapacity must be > 0, got: " + maxCapacity);
        }
     ...
     *
     * <p>If the key exists in the cache, it becomes the most recently used entry.
     * This method updates cache statistics (hit/miss counts).</p>
     *
     ...
     *
     * <p>If the cache already contains a mapping for the key, the old value is replaced.
     * If adding this entry would exceed the capacity, the least recently used entry is evicted.</p>
     *
     ...
     *
     * <p>This method atomically checks if the key exists, and if not, computes the value
     * using the provided mapping function and stores it in the cache. This is useful for
     * lazy-loading expensive computations.</p>
     *
     * <p>The computation is performed while holding the write lock, ensuring thread-safety.</p>
     *
    ...
    public V computeIfAbsent(K key, java.util.function.Function<? super K, ? extends V> mappingFunction) {
        ...
        if (mappingFunction == null) {
            throw new IllegalArgumentException("LruCache.computeIfAbsent: mappingFunction cannot be null");
        }
     ...
     *
     * <p>After this method returns, the cache will be empty and ready for reuse.</p>
     */
    public void clear() {
        writeLock.lock();
        try {
     ...
     *
     * <p>The hit ratio is calculated as: (hits / (hits + misses)) * 100</p>
     *
     ...
     *
     * <p>This does not clear the cache contents, only the statistics.</p>
     */
