 ...
 * Tests cover initialization, item management, selection, and configuration.
 */
...
class TwVirtualFlowTest {
    ...
    void testSelectedIndicesUpdateOnItemsChange() {
        ...
        assertTrue(virtualFlow.getSelectedIndices().isEmpty() || 
                   virtualFlow.getSelectedIndices().size() == 0);
    }
    ...
    void testCellCreation() {
        ...
        Function<String, Node> factory = item -> {
    ...
    void testFluentMethodChaining() {
        ...
        TwVirtualFlow<String> result = virtualFlow
            .items(items)
            .cellFactory(factory)
            .cellHeight(50.0)
            .cellWidth(150.0)
