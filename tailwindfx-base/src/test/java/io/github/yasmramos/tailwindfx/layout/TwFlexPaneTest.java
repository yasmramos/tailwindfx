...
class TwFlexPaneTest extends ApplicationTest {
  ...
  void testSetNullDirection() {
    assertThrows(IllegalArgumentException.class, () -> flexPane.setDirection(null));

    assertThrows(IllegalArgumentException.class, () -> flexPane.direction(null));
  }
  ...
  void testSetNullJustify() {
    assertThrows(IllegalArgumentException.class, () -> flexPane.setJustify(null));
  }
  ...
  void testSetNullAlign() {
    assertThrows(IllegalArgumentException.class, () -> flexPane.setAlign(null));
  }
  ...
  void testSetNullAlignContent() {
    assertThrows(IllegalArgumentException.class, () -> flexPane.setAlignContent(null));
  }
  ...
  void testSetNegativeGap() {
    assertThrows(IllegalArgumentException.class, () -> flexPane.gap(-5.0));
  }
  ...
  void testSetNullPadding() {
    assertThrows(IllegalArgumentException.class, () -> flexPane.padding(null));
  }
  ...
  void testSetNegativeGrow() {
    ...
    assertThrows(IllegalArgumentException.class, () -> TwFlexPane.setGrow(child, -1.0));
  }

  @Test
  @DisplayName("Should throw exception when setting grow on null node")
  void testSetGrowOnNullNode() {
    assertThrows(IllegalArgumentException.class, () -> TwFlexPane.setGrow(null, 1.0));
  }
  ...
  void testSetNegativeShrink() {
    ...
    assertThrows(IllegalArgumentException.class, () -> TwFlexPane.setShrink(child, -0.5));
  }
  ...
  void testSetOrderOnNullNode() {
    assertThrows(IllegalArgumentException.class, () -> TwFlexPane.setOrder(null, 1));
  }
  ...
  void testSetInvalidBasis() {
    ...
    assertThrows(IllegalArgumentException.class, () -> TwFlexPane.setBasis(child, -5.0));
  }
