...
/**
 * Unit tests for EffectApplier. Tests cover effect token application, validation, and edge cases.
 */
...
class EffectApplierTest {
  ...
  class BasicEffectApplicationTests {
    ...
    void testApplyBlurSm() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "blur-sm"));
    }

    @Test
    @DisplayName("Should apply blur-md effect")
    void testApplyBlurMd() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "blur-md"));
    }

    @Test
    @DisplayName("Should apply blur-lg effect")
    void testApplyBlurLg() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "blur-lg"));
    }

    @Test
    @DisplayName("Should apply blur-none effect")
    void testApplyBlurNone() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "blur-none"));
    }

    @Test
    @DisplayName("Should apply grayscale effect")
    void testApplyGrayscale() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "grayscale"));
    }

    @Test
    @DisplayName("Should apply grayscale-0 effect")
    void testApplyGrayscaleNone() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "grayscale-0"));
    }

    @Test
    @DisplayName("Should apply invert effect")
    void testApplyInvert() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "invert"));
    }

    @Test
    @DisplayName("Should apply invert-0 effect")
    void testApplyInvertNone() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "invert-0"));
    }

    @Test
    @DisplayName("Should apply sepia effect")
    void testApplySepia() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "sepia"));
    }

    @Test
    @DisplayName("Should apply sepia-0 effect")
    void testApplySepiaNone() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "sepia-0"));
    }
  }
  ...
  class BrightnessEffectsTests {
    ...
    void testApplyBrightness50() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "brightness-50"));
    }

    @Test
    @DisplayName("Should apply brightness-75 effect")
    void testApplyBrightness75() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "brightness-75"));
    }

    @Test
    @DisplayName("Should apply brightness-100 effect")
    void testApplyBrightness100() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "brightness-100"));
    }

    @Test
    @DisplayName("Should apply brightness-125 effect")
    void testApplyBrightness125() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "brightness-125"));
    }

    @Test
    @DisplayName("Should apply brightness-150 effect")
    void testApplyBrightness150() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "brightness-150"));
    }
  }
  ...
  class ContrastEffectsTests {
    ...
    void testApplyContrast50() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "contrast-50"));
    }

    @Test
    @DisplayName("Should apply contrast-75 effect")
    void testApplyContrast75() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "contrast-75"));
    }

    @Test
    @DisplayName("Should apply contrast-100 effect")
    void testApplyContrast100() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "contrast-100"));
    }

    @Test
    @DisplayName("Should apply contrast-125 effect")
    void testApplyContrast125() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "contrast-125"));
    }

    @Test
    @DisplayName("Should apply contrast-150 effect")
    void testApplyContrast150() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "contrast-150"));
    }
  }
  ...
  class EdgeCasesTests {
    ...
    void testNullNode() {
      assertThrows(
          IllegalArgumentException.class, () -> EffectApplier.applyEffectToken(null, "blur-sm"));
    }

    @Test
    @DisplayName("Should handle null token gracefully")
    void testNullToken() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, null));
    }

    @Test
    @DisplayName("Should handle blank token gracefully")
    void testBlankToken() {
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, ""));
    }
    ...
    void testNonEffectToken() {
      ...
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(button, "bg-blue-500"));

      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "p-4"));
    }
  ...
  class ExceptionHandlingTests {
    ...
    void testUnsupportedEffectToken() {
      ...
      assertDoesNotThrow(() -> EffectApplier.applyEffectToken(label, "unknown-effect-token"));
    }
  }
}
