...
/**
 * Unit tests for StylesheetApplier.
 * Tests cover stylesheet preference mode, static vs dynamic token handling, and edge cases.
 */
...
class StylesheetApplierTest {
    ...
    class EdgeCasesTests {
        ...
        void testWhitespaceOnlyTokens() {
            ...
            assertTrue(button.getStyleClass().isEmpty() || 
    ...
    class TokenClassificationTests {
        ...
        /**
         * Helper method to check if a token is dynamic.
         * This replicates the internal logic of StylesheetApplier.isDynamicToken()
         */
