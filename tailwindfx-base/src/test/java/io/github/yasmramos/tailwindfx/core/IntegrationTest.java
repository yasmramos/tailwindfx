...
public class IntegrationTest {
    ...
    public void testGradientWithRing() {
        ...
        assertTrue(result.hasInlineStyle() || !result.cssClasses().isEmpty(), "Should have ring styling");
    ...
    public void testAspectRatioWithScrollSnap() {
        ...
        assertTrue(result.success(), "Compilation should succeed");
        assertTrue(result.inlineStyle().contains("-fx-pref-width") || result.inlineStyle().contains("ratio"), 
    ...
    public void testCachePerformance() {
        ...
        System.out.println("Cache miss: " + (time1 / 1_000_000.0) + "ms, Cache hit: " + (time2 / 1_000_000.0) + "ms");
    }
