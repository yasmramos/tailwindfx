...
/**
 * Advanced TestFX integration tests demonstrating full capabilities: - Click interactions (single,
 * double, right-click) - Text input and keyboard events - Drag and drop operations - Mouse
 * movements and hover effects - Node lookup and verification - Complex UI workflows
 */
...
class AdvancedTestFXIntegrationTest extends ApplicationTest {
  ...
  class ButtonInteractionTests {
    ...
    void testMultipleButtonClicks() {
      ...
      interact(() -> root.getChildren().addAll(new HBox(btn1, btn2, btn3)));
  ...
  class TextInputTests {
    ...
    void testMultipleFields() {
      ...
      interact(() -> root.getChildren().addAll(new VBox(field1, field2)));
  ...
  class MouseMovementTests {
    ...
    void testMoveBetweenNodes() {
      ...
      interact(() -> root.getChildren().addAll(new VBox(label1, label2)));
  ...
  class WorkflowTests {
    ...
    void testTabNavigation() {
      ...
      interact(() -> root.getChildren().addAll(new VBox(field1, field2, btn)));
