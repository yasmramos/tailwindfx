...
/**
 * Comprehensive tests for the Styles utility class. Covers all style methods including grid, flex,
 * spacing, effects, and transforms.
 */
...
class StylesTest extends ApplicationTest {
  ...
  void testChaining() {
    ...
    Node result = Styles.mx(Styles.my(region, 2), 3);
