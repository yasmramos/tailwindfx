 ...
 *
 * <p>Applies TailwindCSS-like component styles directly via JavaFX API, eliminating the need for
 * static CSS files.
 */
public final class ComponentStyles {
  ...
  public static void applyButtonPrimary(Button btn, String colorName) {
    ...
    btn.setOnMouseEntered(
        e ->
            btn.setBackground(
                new Background(new BackgroundFill(hoverColor, CornerRadii.EMPTY, null))));
    btn.setOnMouseExited(
        e -> btn.setBackground(new Background(new BackgroundFill(color, CornerRadii.EMPTY, null))));
    btn.setOnMousePressed(
        e ->
            btn.setBackground(
                new Background(new BackgroundFill(pressedColor, CornerRadii.EMPTY, null))));
  ...
  public static void applyButtonSecondary(Button btn, String colorName) {
    ...
    btn.setOnMouseEntered(
        e ->
            btn.setBackground(
                new Background(new BackgroundFill(hoverBg, CornerRadii.EMPTY, null))));
    btn.setOnMouseExited(
        e -> btn.setBackground(new Background(new BackgroundFill(bg, CornerRadii.EMPTY, null))));
  }
  ...
  public static void applyButtonOutline(Button btn, String colorName) {
    ...
    btn.setBorder(
        new Border(
            new BorderStroke(
                borderColor, BorderStrokeStyle.SOLID, CornerRadii.EMPTY, new BorderWidths(1))));
  ...
  public static void applyCardBase(Pane pane) {
    ...
    pane.setBorder(
        new Border(
            new BorderStroke(
                borderColor, BorderStrokeStyle.SOLID, new CornerRadii(8), new BorderWidths(1))));
  ...
  public static void applyInputBase(TextInputControl input) {
    ...
    input.setBorder(
        new Border(
            new BorderStroke(
                border, BorderStrokeStyle.SOLID, new CornerRadii(6), new BorderWidths(1))));
