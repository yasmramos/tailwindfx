 ...
 *
 * <p>Scroll snap utilities create scroll containers that "snap" to specific points,
 * commonly used for carousels, image galleries, and section-based layouts.
 *
 * <p>Supported utilities:
 * <ul>
 *   <li>snap-{axis} — Set snap axis (snap-x, snap-y, snap-both)</li>
 *   <li>snap-{type} — Set snap type (snap-mandatory, snap-proximity)</li>
 *   <li>snap-{align} — Set snap alignment (snap-start, snap-end, snap-center, snap-always)</li>
 *   <li>snap-{stop} — Set snap stop behavior (snap-normal, snap-always)</li>
 * </ul>
 *
 * <p>JavaFX Implementation: Uses custom properties that can be interpreted by
 * ScrollPane or custom scroll handlers to implement snapping behavior.
 */
