 ...
 * <ul>
 *   <li>aspect-{ratio} — Set aspect ratio (aspect-square, aspect-video, etc.)</li>
 *   <li>aspect-[value] — Arbitrary aspect ratio (aspect-[4/3], aspect-[16/9])</li>
 * </ul>
 *
 * <p>JavaFX Implementation: Uses -fx-pref-width and -fx-pref-height bindings
 * to maintain aspect ratio, or sets explicit dimensions based on parent container.
 */
